...
std::ostream& operator<<(std::ostream& os, const ErrorCode error_code)
{
  ...
  case ErrorCode::kUnavailable: {
    return os << "tyl::engine::asset::ErrorCode::kUnavailable";
  }
  case ErrorCode::kExists: {
    return os << "tyl::engine::asset::ErrorCode::kExists";
  }
  case ErrorCode::kLoadFailed: {
    return os << "tyl::engine::asset::ErrorCode::kLoadFailed";
  }
  case ErrorCode::kUnimplementedLoader: {
    return os << "tyl::engine::asset::ErrorCode::kUnimplementedLoader";
  }
  case ErrorCode::kUnknownExtension: {
    return os << "tyl::engine::asset::ErrorCode::kUnknownExtension";
  }
  }
  return os << "tyl::engine::asset::ErrorCode::*";
}
...
std::ostream& operator<<(std::ostream& os, const TypeCode type_code)
{
  ...
  {
  case TypeCode::kAudio: {
    return os << "tyl::engine::asset::TypeCode::kAudio";
  }
  case TypeCode::kTexture: {
    return os << "tyl::engine::asset::TypeCode::kTexture";
  }
  case TypeCode::kText: {
    return os << "tyl::engine::asset::TypeCode::kText";
  }
  }
  return os << "tyl::engine::asset::TypeCode::*";
}
